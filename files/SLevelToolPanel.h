...
private:
    ...
    // ── Coordinate inputs ────────────────────────────────────────────
    TOptional<float>    GetLatValue()    const;
    TOptional<float>    GetLonValue()    const;
    TOptional<float>    GetRadiusValue() const;
    ...
    // ── Log ──────────────────────────────────────────────────────────
    TSharedRef<SWidget> GenerateLogRow(TSharedPtr<FString> Item,
