...
class S1_API AShooterPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(EditAnywhere, Category="Shooter|UI")
	TSubclassOf<UShooterCrosshairUI> CrosshairUIClass;
	...
	UPROPERTY()
	TObjectPtr<UShooterCrosshairUI> CrosshairUI;
...
protected:
	...
	/** Called when the possessed pawn equips or loses a weapon */
	UFUNCTION()
	void OnWeaponEquipped(bool bHasWeapon);
