 ...
 */
UCLASS(abstract)
class S1_API AShooterWeapon : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	/** Optional data asset that overrides weapon tuning parameters */
	UPROPERTY(EditAnywhere, Category="Weapon Data")
	TObjectPtr<UShooterWeaponData> WeaponData;
	...
	/** Amount of vertical firing recoil to apply to the owner */
	UPROPERTY(EditAnywhere, Category="Aim", meta = (ClampMin = 0, ClampMax = 100))
	float FiringRecoil = 0.0f;

	/** Maximum random horizontal recoil per shot (overridden by WeaponData if set) */
	UPROPERTY(EditAnywhere, Category="Aim", meta = (ClampMin = 0, ClampMax = 50))
	...
	/** Camera shake to play on each shot (overridden by WeaponData if set) */
	UPROPERTY(EditAnywhere, Category="Camera Shake")
	TSubclassOf<UCameraShakeBase> FireCameraShakeClass;

	/** Camera shake intensity multiplier (overridden by WeaponData if set) */
	UPROPERTY(EditAnywhere, Category="Camera Shake", meta = (ClampMin = 0, ClampMax = 10))
	float CameraShakeScale = 1.0f;

	/** Projectile speed override; 0 means use the projectile's default (overridden by WeaponData if set) */
	UPROPERTY(EditAnywhere, Category="Projectile", meta = (ClampMin = 0, ClampMax = 100000, Units = "cm/s"))
